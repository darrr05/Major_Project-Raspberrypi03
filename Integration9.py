...
class SupermarketApp(tk.Tk):
    ...
    def show_mismatch_popup(self, live_counts_win, dome, ribbon):
        ...
        if focused_widget is not None and live_counts_win != focused_widget.winfo_toplevel():
            return
        border_color = "white" if self.theme == "dark" else "black"
        ...
        width, height = 400, 200
        x = (live_counts_win.winfo_screenwidth() // 2) - (width // 2)
        y = (live_counts_win.winfo_screenheight() // 2) - (height // 2)
