...
#         self.attributes('-fullscreen', True)
    ...
    def create_widgets(self):
        ...
        self.settings_btn = tk.Button(self.top_bar, text="⚙️", font=("Times New Roman", 20), command=self.open_settings,
...
# Store the reference to the image so it doesn't get garbage collected
    ...
    def activity_log(self):
        if not self.current_user and not self.login_prompt():
            return
        messagebox.showinfo("Activity Log", f"Showing logs for {self.current_user}")
