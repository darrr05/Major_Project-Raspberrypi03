...
# Adjustable parameters for EasyOCR
USE_FIXED_ROI = False
PADDING_X = 50
PADDING_Y = 40
    ...
    def ocr_loop(self):
        while True:
            ...
            if detected_text:
                ...
                debounce_threshold = 3 if len(detected_text) == 1 else DEBOUNCE_COUNT
            ...
            if frame is not None:
                ...
                if detections:
                    ...
                    if label == 'number' and conf > 0.5:
                        ...
                        results = self.reader.readtext(thresh, allowlist='0123456789', detail=0, min_size=3, text_threshold=0.4, adjust_contrast=0.6)
                        ...
                        if detected_text:
                            ...
                            if len(self.recent_detections) == DEBOUNCE_COUNT:
                                if all(text == self.recent_detections[0] for text in self.recent_detections):
                                    ...
                                    self.ribbon_count.set(int(padded_text))
                        else:
                            self.recent_detections.clear()
