...
DEBOUNCE_COUNT = 2  # Number of consistent detections before confirming
...
class SupermarketApp(tk.Tk):
    def __init__(self):
        ...
        self.ribbon_count.trace_add("write", lambda *args: print(f"ribbon_count changed to: {self.ribbon_count.get()}"))
    ...
    def detection_loop(self):
        while self.running:
            ...
            try:
                ...
                print("OCR queue full, skipping frame")
            time.sleep(0.2)  # Prevent overloading the queue
    ...
    def start(self):
        ...
        self.ribbon_count.set(42)
        print(f"Test: Riibon 42")
        def update_counts():
            ...
            try:
                self.ribbon_count.set(int(confirmed_number))
                print(f"Update Counts: Successfully set ribbon_count to {confirmed_number}")
            except ValueError as e:
                print(f"Update Counts: ValueError setting ribbon_count, confirmed_number={confirmed_number}, error={e}")
