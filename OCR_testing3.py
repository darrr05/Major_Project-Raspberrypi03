...
DEBOUNCE_COUNT = 3  # Number of consistent detections before confirming
...
class SupermarketApp(tk.Tk):
    ...
    def ocr_loop(self):
        while True:
            ...
            if roi is None:
                break
            results = self.reader.readtext(roi, allowlist='0123456789', min_size=15, text_threshold=1)
            ...
            if frame is not None:
                ...
                if detections:
                    ...
                    if label == 'number' and conf > 0.5:
                        ...
                        results = self.reader.readtext(thresh, allowlist='0123456789', min_size=10, text_threshold=0.7)
